...
import { Package, LogOut, ShieldCheck, Mail, User as UserIcon } from 'lucide-react';
...
export default function Account() {
  ...
  return (
    <div className="container-wide max-w-3xl py-10">
      <h1 className="mb-8 font-display text-3xl font-bold text-white">My account</h1>

      <div className="card mb-6 flex items-center gap-4 p-6">
        <div className="grid h-16 w-16 place-items-center rounded-full bg-accent/15 text-2xl font-bold text-accent-soft">
        ...
        {isAdmin && <span className="badge ml-auto bg-accent/15 text-accent-soft">Admin</span>}
      </div>
      ...
      <div className="mt-6 flex flex-wrap gap-3">
        ...
        <button onClick={() => { logout(); navigate('/'); }} className="btn-ghost text-rose-300">
